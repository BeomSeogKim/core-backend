...
- [[2-Areas/backend/05-infrastructure/kafka/Kafka Exactly-once Semantics|Kafka Exactly-once Semantics]] — 메시지 전달 보장 수준
- [[2-Areas/backend/05-infrastructure/kafka/Kafka 메타데이터 관리, Zookeeper에서 KRaft로|Zookeeper에서 KRaft로]] — 클러스터 메타데이터 관리
- [[2-Areas/backend/05-infrastructure/monitoring|모니터링]] — DLQ 알림/모니터링 연동
